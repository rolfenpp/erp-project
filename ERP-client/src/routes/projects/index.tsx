...
function ProjectsIndexComponent() {
  ...
  // Card list still shows on xs; table on sm+
  const smUp = useMediaQuery(theme.breakpoints.up('sm'), { noSsr: true })
  // Custom breakpoint — compact mode below 1410px
  ...
  // Stats should always show total data, not filtered data
                  ...
                  <Table stickyHeader size={compact1410 ? 'small' : 'medium'}>
                    <TableHead>
                      <TableRow>
                        ...
                        {/* Hide budget and timeline under 1410px */}
                        <TableCell
                          align="right"
                        ...
                        <TableRow key={project.id} hover>
                          <TableCell sx={{ whiteSpace: 'nowrap' }}>
                            <Box>
                              ...
                              {/* Show client and manager inline on compact mode */}
                              {compact1410 && (
                                <Box sx={{ mt: 0.5 }}>
